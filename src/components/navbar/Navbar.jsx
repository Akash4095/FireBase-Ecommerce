  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
      ...
      <header className="relative bg-pink">
        <nav aria-label="Top" className="bg-pink-600 px-4 sm:px-6 lg:px-8 shadow-xl " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className="">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-white  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>E-Bharat</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {/* <SearchBar /> */}
                  <Filter />
                  <Link to={'/allproducts'} className="text-sm font-medium text-gray-700 " style={{ color: 'white' }}>
                    All Products
                  </Link>
                  {user ? <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: 'white' }}>
                    Order
                  </Link> : <Link to={'/signup'} className="text-sm font-medium text-gray-700 " style={{ color: 'white' }}>
                    Signup
                  </Link>}

                  {user?.user?.email === 'knupadhyay784@gmail.com' ?
                    <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: 'white' }}>
                      Admin
                    </Link> : ""}
                  {user ? <a onClick={logout} className="text-sm font-medium text-gray-700 cursor-pointer  " style={{ color: 'white' }}>
                    Logout
                  </a> : ""}
                </div>
